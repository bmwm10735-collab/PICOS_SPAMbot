...
ADMIN_UID = "15138929771"  # Your admin UID
server2 = "ME"
key2 = "MAHFUJ"
...
ADMIN_AUTO_EMOTE_IDS = [909000074, 909049001, 909000012, 909000014, 909000045, 909037002, 909000020, 909050010]
                        ...
                        if inPuTMsG.startswith('/join'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    if can_send_emote_to(sender_uid) and can_send_emote_to(15138929771):
...
async def MaiiiinE():
    Uid, Pw = '4656195023', '50639B8E7621B77B3A53ED0AECD7BB35AE5BBA01E299D7B27D9A29BF6A467734'
